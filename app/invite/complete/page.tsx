...
import { InviteCompleteForm } from './invite-complete-form'
    ...
    return (
        <main className="min-h-screen bg-[radial-gradient(circle_at_20%_10%,rgba(20,184,166,0.18),transparent_28%),linear-gradient(135deg,#f8fafc_0%,#eef6f5_48%,#f5f7fb_100%)] p-4 text-foreground">
            <div className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-6xl items-center gap-6 lg:grid-cols-[1.05fr_0.95fr]">
                <section className="hidden min-h-[620px] flex-col justify-between rounded-lg border border-white/60 bg-[linear-gradient(145deg,rgba(15,23,42,0.96),rgba(21,94,117,0.88))] p-8 text-white shadow-2xl shadow-slate-900/[0.12] lg:flex">
                    <div>
                        ...
                        <div className="mt-14 max-w-xl">
                            ...
                            <p className="mt-4 text-base leading-7 text-slate-200/78">
                                Your account will be connected directly to the invited workspace after setup.
                            </p>
                        </div>
                    </div>
                </section>
                    ...
                    <Card className="border-white/70 bg-white/[0.92] shadow-xl shadow-slate-900/[0.08] backdrop-blur">
                        <CardContent className="p-6 sm:p-8">
                            <div className="mb-8">
                                ...
                                <h2 className="mt-2 text-3xl font-semibold tracking-tight">Finish account setup</h2>
                                <p className="mt-2 text-sm text-muted-foreground">
                                    Add your name and password to accept the workspace invitation.
                                </p>
                            </div>
